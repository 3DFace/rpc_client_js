...
/***/ function(module, exports, __webpack_require__) {
	...
	/* harmony import */ Object.defineProperty(__WEBPACK_IMPORTED_MODULE_0_request___default, 'a', { get: __WEBPACK_IMPORTED_MODULE_0_request___default });
	/* author: Ponomarev Denis <ponomarev@gmail.com> */
	...
	function RequestLayer(url, options, pre_request_fn, post_request_fn){
		...
		this.send = function(request_str){
			...
			return new Promise(function(resolve, reject){
				...
				/* harmony import */__WEBPACK_IMPORTED_MODULE_0_request___default.a.bind()(requestOptions, function(error, response, body){
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* harmony reexport */ if(Object.prototype.hasOwnProperty.call(__WEBPACK_IMPORTED_MODULE_6__RequestLayer__, "a")) Object.defineProperty(exports, "RequestLayer", {configurable: false, enumerable: true, get: function() { return __WEBPACK_IMPORTED_MODULE_6__RequestLayer__["a"]; }});
